import numpy as np
fromMobile = 43264633637645223

class OfflineEnv(object):
    
    def __init__(self, users_dict, users_history_lens, florals_id_to_florals, state_size, fix_user_id=None):

        self.users_dict = users_dict
        self.users_history_lens = users_history_lens
        self.items_id_to_name = florals_id_to_florals
